...
export const BRAND = {
  ...
  percentileCaveat: 'Estimated percentile ranges are directional comparisons against published norm tables (such as NWEA MAP and ASVAB AFQT). They are not nationally normed scores for QuestionLiftIQ.',
